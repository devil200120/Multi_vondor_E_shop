...
const EnhancedShippingService = require("../utils/EnhancedShippingService");
const catchAsyncErrors = require("../middleware/catchAsyncErrors");
const ErrorHandler = require("../utils/ErrorHandler");

const router = express.Router();
const shippingService = new DynamicShippingService();
const enhancedShippingService = new EnhancedShippingService();
  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      const {
        ...
        isExpress,
        orderId,
        products // Array of products with shipping configurations
      } = req.body;
      ...
      const result = await enhancedShippingService.calculateShippingCost({
        shopId,
        userId,
        userLocation,
        orderValue,
